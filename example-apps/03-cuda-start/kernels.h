...
__global__ void genMandelbrot(cudaSurfaceObject_t surf, int texWidth, int texHeight, float x, float y, float height, int maxIter, bool useDouble, int timeStep);
void launchGenMandelbrot(cudaSurfaceObject_t surf, int texWidth, int texHeight, float x, float y, float height, int maxIter, bool useDouble, int timeStep);